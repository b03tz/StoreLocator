...
$premiumFile = $modx->getOption('core_path').'components/storelocator/premium.txt';
...
if (isset($_GET['downloadLink'])) { 
	...
	return file_get_contents('http://www.scherpontwikkeling.nl/components/storelocator/about.html?premium='.$premium);
}