 ...
 * @subpackage request
 */
abstract class StoreLocatorController extends modExtraManagerController {
    /** @var modX $modx */
    public $modx;
     ...
     * @param array $config
     */
    function __construct(StoreLocator &$storelocator,array $config = array()) {
        $this->storelocator =& $storelocator;
        $this->modx =& $storelocator->modx;
    ...
    public function runProcessor($processor,array $scriptProperties = array()) {
        ...
        try {
            ...
            $this->modx->log(modX::LOG_LEVEL_ERROR,'[StoreLocator] '.$e->getMessage());
        }
        return $output;
    }
	
	public function getLanguageTopics() {
		return array('storelocator:default');
	}
}